                ...
                <div className="pt-32 pb-12 md:pt-40 md:pb-20">
                    ...
                    <header className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                        ...
                        <p className="text-xl text-gray-400" data-aos="fade-up"
                           data-aos-delay="200">{aboutContent.description}</p>
                    </header>
